...
cyclesRotation = 10 #number of PWM cycles for the turntable in one motion segment
...
def changeCyclesRotation(slider_value):
    global cyclesRotation
    cyclesRotation = int(slider_value)*10
    print("Your turntable will rotate in " + str(cyclesRotation/10) + " degree increments")
